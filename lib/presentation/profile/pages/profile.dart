...
import 'package:hitplay/common/widgets/appbar/app_bar.dart';
import 'package:hitplay/presentation/profile/bloc/favorite_songs_cubit.dart';
import 'package:hitplay/presentation/profile/bloc/favorite_songs_state.dart';
import 'package:hitplay/presentation/profile/bloc/profile_info_cubit.dart';
                ...
                if(state is FavoriteSongsLoaded) {
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      final artist = state.favoriteSongs[index].artist;
                      final title = state.favoriteSongs[index].title;
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: NetworkImage(
                                        'https://firebasestorage.googleapis.com/v0/b/hitplay01.firebasestorage.app/o/covers%2FCalvin%20Harris%20%2C%20Dua%20Lipa%20%20-%20One%20Kiss.jpg?alt=media'
                                      )
                                    )
                                  ),
                                ),
